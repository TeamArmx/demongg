...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <div class="main-container" id="container">
        ...
        <div id="content" class="main-content">
            ...
            <button type="button" class="btn btn-success btn-block" onclick="window.location.href='https://t.me/D3M0N_Giveaway'" id='hideshow'>CLICK HERE TO JOIN CHANNEL</button>
...
<div class="widget-list row">
                ...
                <div class="widget-holder widget-full-height widget-flex col-lg-6">
                    <div class="md-form">
    <div class="col-md-12">
  <textarea type="text" style="text-align: center;" id="lista" class="md-textarea form-control" rows="6" placeholder="55673378xxxxx|xx|xxxx|xxx"></textarea>
  <label for="lista"></label>
  <div name="lines_count" type="hidden" id="lines" style="display:none;" >Loading...</div>
</div>
    <div class="col-md-12">
  <textarea type="text" style="text-align: center;" id="sec" class="md-textarea form-control" rows="1" placeholder="sk_live_xxxxxxxxxx"></textarea>
  <div name="lines_count" type="hidden" id="lines" style="display:none;" >Loading...</div>
</div>
<br>
<div class="col-md-12">
  <textarea type="text" style="text-align: center;" id="amt" class="md-textarea form-control" rows="1" placeholder="Amount"></textarea>
  <div name="lines_count" type="hidden" id="lines" style="display:none;" >Loading...</div>
<br>
  <div name="lines_count" type="hidden" id="lines" style="display:none;" >Loading...</div>
</div>
...
<option  value="hi.php">SELECT GATE</option>
<option  value="customusd.php">$ CUSTOM CHARGE</option>
<option  value="customeur.php">€ CUSTOM CHARGE</option>
<option  value="custominr.php">₹ CUSTOM CHARGE</option>
</select>
<div>
                </div>
                  ...
                  <div class="row layout-top-spacing">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing" id="cvv_lives" style="display: none">
                        <div class="widget widget-one">
                            <div class="widget-heading">
                                <h6 class="cvv-master">CHARGED</h6>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing" id="ccn_lives" style="display: none">
                        <div class="widget widget-one">
                            <div class="widget-heading">
                                <h6 class="ccn-master">CVV & CCN</h6>
      ...
      function start() {
        ...
        req.onreadystatechange = function () {
          if (req.readyState == 4 && req.status == 200) {
            if (req.responseText.match("CHARGED")) {
            remove();
            ap++;
            tested --;
            approved(req.responseText + "");
            }
            else if (req.responseText.match("APPROVED")) { 
            remove();
            rp++;
            tested --;
        ...
        req.open("GET", gate + value + '&sec=' + sec + '&amt=' + amt + '&idd=' + idd, true);
        req.send(null);
        }, 500 * index);
        });
      }
